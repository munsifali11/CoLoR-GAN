...
from model_colorgan import Extra
from model_colorgan import CoLoRPatchDiscriminator as Discriminator  # , Projection_head
...
if __name__ == "__main__":
    ...
    parser.add_argument('--lora_alpha_conv', type=float, default=1.0)
    parser.add_argument('--lora_alpha_fc', type=float, default=1.0)
    ...
    generator = Generator(
        args.size, args.latent, args.n_mlp, channel_multiplier=args.channel_multiplier, lifelong=True, 
        rank=args.rank, use_act=args.use_act,
        lora_alpha_conv = args.lora_alpha_conv, lora_alpha_fc=args.lora_alpha_fc,
    ).to(device)
